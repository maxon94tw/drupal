...
/**
 * Access controller for the entity smile entity.
 *
 * @see \Drupal\entity_smile\Entity\EntitySmile.
 */
class EntitySmileAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add entity smile entities');
  }
